<template>
  <div class="home">
    <div class="content">
      ...
      <x-button class="btn" @click.native="viewLucky" v-show="sport.doLottery">查看中奖列表</x-button>
      <x-button class="btn" @click.native="viewChart" v-if="sport.isOnline">查看实时得分</x-button>
